...
ANALYZERS="$ROOT/Blankie/Utils/AudioAnalyzer.swift $ROOT/Blankie/Utils/AudioAnalyzer+Weighting.swift $ROOT/Blankie/Utils/AudioAnalyzer+LUFS.swift $ROOT/Blankie/Utils/DebugLog.swift"
stale=0
[ -x "$BIN" ] || stale=1
